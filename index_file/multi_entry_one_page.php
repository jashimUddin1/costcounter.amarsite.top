...
<div class="card p-3 mb-4">
  ...
  <form method="POST" action="core_file/multi_entry_one_page_core.php">
    ...
    <div class="mb-3">
      ...
      <textarea id="bulkInput" name="bulk_description" class="form-control" rows="10" placeholder="👉 উদাহরণ:
...
document.getElementById("togglePreview").addEventListener("click",function(){
  ...
  if(wrap.style.display==="none"){
    ...
    document.getElementById("previewBody").innerHTML =
      '<tr><td colspan="3" class="text-danger fw-bold text-center">🚧 এই ফিচার এখন ডেভেলপমেন্টে আছে</td></tr>';
  }else{
