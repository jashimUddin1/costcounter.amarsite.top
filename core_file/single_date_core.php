...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $category_map = [
        'বাজার' => ['বাজার', 'চাল', 'পোলার চাল', 'চাউল', 'আলু', 'ডাল', 'লবণ ', 'দুধ ', 'নুডুলস', 'চিনা বাদাম', 'সেমাই', 'হুইল পাউডার', 'চিনি', 'মসলা', 'সাবান', 'ভিমবার', 'ডিম', 'মরিচ', 'টমেটো', 'রেহা', 'মুলা', 'পেঁয়াজ', 'রসুন', 'তেল', 'তরকারি'],
