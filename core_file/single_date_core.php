...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $category_map = [
        'বাজার' => ['বাজার', 'চাল', 'পোলার চাল', 'চাউল', 'মাছ', 'গোস্তো', 'গোসত', 'গোস্ত', 'মুরগী', 'মুরগি', 'কক মুরগি', 'তেল', 'তৈল', 'পেয়াজ', 'পিয়াজ', 'হলুদ', 'হলদি', 'সরিষা তৈল', 'শরিসা তৈল', 'সরিশা তৈল', 'রশুন', 'রসুন', 'আদা', 'তাল-মিশ্রি', 'তাল মিশ্রি', 'ময়দা', 'আলু', 'ডাল', 'লবণ ', 'দুধ ', 'নুডুলস', 'চিনা বাদাম', 'সেমাই', 'হুইল পাউডার', 'চিনি', 'মসলা', 'সাবান', 'ভিমবার', 'ডিম', 'মরিচ', 'টমেটো', 'রেহা', 'মুলা', 'পেঁয়াজ', 'রসুন', 'তেল', 'তরকারি', 'অন্যন্য বাজার'],

        'বাহিরেরখরচ' => ['খাবার', 'বাহিরের খাবার', 'ফল', 'রুটি', 'বাদাম বুট', 'বুট বাদাম'],
        'মোবাইলখরচ' => ['রিচার্জ', 'ফ্লেক্সিলোড', 'টপআপ'],
        'গাড়িভাড়া' => ['গাড়ি ভাড়া', 'বাস ভাড়া', 'রিক্সা ভাড়া'],
        'বাসাভাড়া' => ['ভাড়া', 'বাসা ভাড়া', 'রুমভাড়া', 'বাড়িভাড়া', 'বাড়ি ভাড়া', 'বাড়ি ভাড়া', 'হাউস রেন্ট'],

        'বিল' => ['বিদ্যুৎ', 'ইন্টারনেট', 'গ্যাস', 'পানি', 'নেট বিল'],
